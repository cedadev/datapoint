...
with the HPC architecture on which the archive resides (see the `JASMIN homepage <https://jasmin.ac.uk/>` for more details), but not so good for open access outside of JASMIN. 
